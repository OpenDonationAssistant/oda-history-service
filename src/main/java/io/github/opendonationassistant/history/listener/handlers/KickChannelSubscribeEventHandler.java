...
@Singleton
public class KickChannelSubscribeEventHandler
  extends AbstractMessageHandler<
    KickChannelSubscribeEventHandler.KickChannelSubscribeEvent
  > {

  private final HistoryItemRepository repository;

  public KickChannelSubscribeEventHandler(
    ObjectMapper mapper,
  ...
  @Override
  public void handle(KickChannelSubscribeEvent event) throws IOException {
