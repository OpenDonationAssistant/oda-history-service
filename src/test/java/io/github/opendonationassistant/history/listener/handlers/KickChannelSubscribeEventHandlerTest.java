...
import io.github.opendonationassistant.history.listener.handlers.KickChannelSubscribeEventHandler.KickChannelSubscribeEvent;
...
public class KickChannelSubscribeEventHandlerTest {
  ...
  @Test
  public void testHandlingKickSubscribeEvent() throws IOException {
    ...
    var handler = new KickChannelSubscribeEventHandler(objectMapper, repository);
    handler.handle(objectMapper.writeValueAsBytes(event));

    var saved = repository.findByOriginId("kick-sub-created");
